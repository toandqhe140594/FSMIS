          ...
          <Card containerStyle={{ width: "100%", margin: 0, padding: 0 }}>
            ...
            <Box m={3}>
              ...
              <Text>
                ...
                fringilla quis varius pharetra lacinia neque turpis. Ac nunc, ut
                vel in arcu, sed feugiat. Vitae est duis ac, et imperdiet
            ...
            <Box m={3}>
              ...
              <Box flexDirection="row">
                &#8226;
                <Text>
                  Mỗi cần thủ chỉ được sử dụng 1 cần tay, thẻo đôi lưỡi to không
                  quá 8 và có dây bảo hiểm.
                </Text>
              </Box>
              <Box flexDirection="row">
                &#8226;
