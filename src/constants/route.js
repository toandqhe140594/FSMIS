...
export const FMANAGE_LAKE_PROFILE = "FManage Lake Profile Screen";
export const FMANAGE_LAKE_ADD = "FManage Add Lake";
export const FMANAGE_LAKE_EDIT = "FManage Edit Lake";
export const FMANAGE_LAKE_FISH_ADD = "FManage Add Fish To Lake";
export const FMANAGE_LAKE_FISH_RESTOCK = "FManage Restock Fish In Lake";
