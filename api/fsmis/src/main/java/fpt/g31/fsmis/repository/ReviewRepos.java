...
public interface ReviewRepos extends JpaRepository<Review, Long> {
    ...
    Page<Review> findByFishingLocationIdAndActiveIsTrueOrderByScoreDescTimeDesc(Long id, Pageable pageable);

    Page<Review> findByFishingLocationIdAndActiveIsTrueOrderByScoreAscTimeDesc(Long id, Pageable pageable);
